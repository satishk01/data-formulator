    ...
    >
        <TableCell align="left">
            <Autocomplete
                ...
                options={['openai', 'azure', 'ollama', 'anthropic', 'gemini', 'bedrock']}
        ...
        <TableCell align="right">
            <TextField size="small" type="text" fullWidth
                placeholder={newEndpoint === "bedrock" ? "AWS Region (e.g., us-east-1)" : "api_base"}
                slotProps={{
                    input: {
                        style: { fontSize: "0.875rem" }
                    }
        ...
        <TableCell align="right">
            <TextField size="small" type="text" fullWidth
                ...
                autoComplete='off'
                placeholder={newEndpoint === "bedrock" ? "AWS Secret Access Key" : "api_version"}
            />
        </TableCell>
